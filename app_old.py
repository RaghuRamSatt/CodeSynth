...
#     agent_type = st.selectbox(
#     "Choose the agent to generate code:",
#     ["claude", "openai-gpt4.1", "groq-llama", "groq-gemma", "opensource"],
#     index=0,
...
# # IMPORTANT: Patch pandas read_csv to handle /sandbox/data.csv path
# original_read_csv = pd.read_csv
# def patched_read_csv(filepath_or_buffer, *args, **kwargs):
#     if filepath_or_buffer == '/sandbox/data.csv':
#         # Use the already loaded dataframe instead
#         return df
